			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						...
						<div>
							<input type="text" name="anestesiologo" id="anestesiologo" class="form-control"
								   value="Dr. Serge Amador">
						</div>
					</div>
					<div class="procedimiento_parto">
						...
						<div class="col-md-3">
							...
							<div>
								<textarea name="complicacion_maternal" id="complicacion_maternal"
						...
						<div class="col-md-3">
							...
							<div>
								<textarea name="complicacion_fetal" id="complicacion_fetal"
										  class="form-control"></textarea>
							</div>
						</div>
						<div class="col-md-3">
							...
							<div>
								<input type="text" name="pediatra" id="pediatra" class="form-control"
									   value="Dr. Rafael Centeno">
							</div>
						</div>
					</div>
					<div class="col-md-3">
