...
<script>
    ...
    function saveTrimestre(este) {
        ...
        var data = {
            ...
            "edad_getacional"                    : $(form).find('#edad_getacional_1trimestre').val(),
    ...
    function saveEstructural(este) {
        ...
        addFeto($(form).find('#child_estructural'), 'UltrasonidoEstructural');
         ...
         var data = {
            ...
            "edad_getacional"                           : $(form).find('#edad_getacional_estructural').val(),
    ...
    function saveNeurosonografia(este) {
        ...
        addFeto($(form).find('#child_neurosonografia'), 'Neurosonografia');
         ...
         var data = {
            ...
            "edad_getacional"               : $(form).find('#edad_getacional_neurosonografia').val(),
    ...
    function saveEcocardiografia(este) {
        ...
        var data = {
            ...
            "edad_getacional" : $(form).find('#edad_getacional_ecocardiografia').val(),
    ...
    function saveDoppler(este) {
        ...
        var data = {
            ...
            "edad_getacional"               : $(form).find('#edad_getacional_doppler').val(),
