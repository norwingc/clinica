	...
	<script>
		...
		function saveTrimestre(este) {
			...
			var data = {
				...
				"anomalias_familiares": $(form).find('#anomalias_familiares_1trimestre').val(),
				"anomalias_familiares_descripcion": $(form).find('#anomalias_familiares_descripcion_1trimestre').val(),
				"transtorno_desarrollo_intelectual": $(form).find('#transtorno_desarrollo_intelectual_1trimestre').val(),
				"transtorno_desarrollo_intelectual_descripcion": $(form).find('#transtorno_desarrollo_intelectual_descripcion_1trimestre').val(),
				"enfermdad_genetica": $(form).find('#enfermdad_genetica_1trimestre').val(),
				"enfermdad_genetica_descripcion": $(form).find('#enfermdad_genetica_descripcion_1trimestre').val(),
				"perdida_gestacional_recurrente": $(form).find('#perdida_gestacional_recurrente_1trimestre').val(),
				"perdida_gestacional_recurrente_descripcion": $(form).find('#perdida_gestacional_recurrente_descripcion_1trimestre').val(),
				"infertilidad": $(form).find('#infertilidad_1trimestre').val(),
		...
		function saveEstructural(este) {
			...
			var data = {
				...
				"anomalias_familiares": $(form).find('#anomalias_familiares_estructural').val(),
				"anomalias_familiares_descripcion": $(form).find('#anomalias_familiares_descripcion_estructural').val(),
				"transtorno_desarrollo_intelectual": $(form).find('#transtorno_desarrollo_intelectual_estructural').val(),
				"transtorno_desarrollo_intelectual_descripcion": $(form).find('#transtorno_desarrollo_intelectual_descripcion_estructural').val(),
				"enfermdad_genetica": $(form).find('#enfermdad_genetica_estructural').val(),
				"enfermdad_genetica_descripcion": $(form).find('#enfermdad_genetica_descripcion_estructural').val(),
				"perdida_gestacional_recurrente": $(form).find('#perdida_gestacional_recurrente_estructural').val(),
				"perdida_gestacional_recurrente_descripcion": $(form).find('#perdida_gestacional_recurrente_descripcion_estructural').val(),
				"infertilidad": $(form).find('#infertilidad_estructural').val(),
				"infertilidad_descripcion": $(form).find('#infertilidad_descripcion_estructural').val(),
				"consanguinidad": $(form).find('#consanguinidad_estructural').val(),
				"consanguinidad_descripcion": $(form).find('#consanguinidad_descripcion_estructural').val(),
				"fetos": fetos
			};
		...
		function addFeto(child, examen) {
			...
			if (examen == 'UltrasonidoTrimestre') {
				fetos.push({
					...
					"ducto_venoso": $(child).find('#ducto_venoso_1trimestre').val(),
					"regurgitacion_tricuspidea": $(child).find('#regurgitacion_tricuspidea_1trimestre').val(),
				});
			}
