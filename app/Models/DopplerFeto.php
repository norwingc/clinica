...
class DopplerFeto extends Model
{
     ...
     */
    protected $fillable = [
        "vitalidad_feto", "localizacion_feto", 'localizacion_feto', "presentacion", "situacion", "posicion", "fcf", "sexo_feto", "dbp_medida", "dbp_semanas", "cc_medida", "cc_semanas", "ca_medida", "ca_semanas", "lf_medida", "lf_semanas",
