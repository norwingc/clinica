...
class Paciente extends Model
{
	...
	protected $fillable = [
		...
		'contacto_celular', 'trabajo', 'escolaridad', 'tipo_rh', 'paridad', 'morbilidad', 'embarazada', 'ultima_regla', 'personal_comentarios'
	];
	...
	{
		return $this->hasMany(\App\Models\PacienteImage::class);
	}
