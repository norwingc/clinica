...
class UltrasonidoPelvico extends Model
{
     ...
     */
    protected $fillable = [
        "referido", "edad", "date", "paridad", "edad_getacional", "morbilidad", "rh_tipo", "bordes", "ecos_interior", "utero", "forma", "paredes", "longitud",
        ...
        "reaccion_coridodecidual", "presencia_vesicula", "presencia_yema", "vitalidad", "longitud_craneo", "edad_gestacional", "fecha_parto", "ovario_izquierdo",
        "ovario_izquierdo_1", "ovario_izquierdo_2", "presencia_masa_anexial_izquierdo", "ovario_izquierdo_tipo", "ovario_izquierdo_vegetaciones",
